...
// UnimplementedLibrarianSearcherServiceServer must be embedded to have
...
func (UnimplementedLibrarianSearcherServiceServer) testEmbeddedByValue() {}
...
func RegisterLibrarianSearcherServiceServer(s grpc.ServiceRegistrar, srv LibrarianSearcherServiceServer) {
	// If the following call pancis, it indicates UnimplementedLibrarianSearcherServiceServer was
