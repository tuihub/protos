...
func (c *librarianSephirahServiceClient) PUpsertFeed(ctx context.Context, in *PUpsertFeedRequest, opts ...grpc.CallOption) (*PUpsertFeedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PUpsertFeedResponse)
	err := c.cc.Invoke(ctx, LibrarianSephirahService_PUpsertFeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *librarianSephirahServiceClient) PGetFeed(ctx context.Context, in *PGetFeedRequest, opts ...grpc.CallOption) (*PGetFeedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PGetFeedResponse)
	err := c.cc.Invoke(ctx, LibrarianSephirahService_PGetFeed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLibrarianSephirahServiceServer) PUpsertFeed(context.Context, *PUpsertFeedRequest) (*PUpsertFeedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PUpsertFeed not implemented")
}
func (UnimplementedLibrarianSephirahServiceServer) PGetFeed(context.Context, *PGetFeedRequest) (*PGetFeedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PGetFeed not implemented")
}
...
func _LibrarianSephirahService_PUpsertFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PUpsertFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibrarianSephirahServiceServer).PUpsertFeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibrarianSephirahService_PUpsertFeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibrarianSephirahServiceServer).PUpsertFeed(ctx, req.(*PUpsertFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LibrarianSephirahService_PGetFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PGetFeedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibrarianSephirahServiceServer).PGetFeed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LibrarianSephirahService_PGetFeed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibrarianSephirahServiceServer).PGetFeed(ctx, req.(*PGetFeedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
