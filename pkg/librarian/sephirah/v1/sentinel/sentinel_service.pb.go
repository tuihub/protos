...
func (x *SentinelLibraryAppBinary) Reset() {
	*x = SentinelLibraryAppBinary{}
	mi := &file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SentinelLibraryAppBinary) Descriptor() ([]byte, []int) {
	return file_librarian_sephirah_v1_sentinel_sentinel_service_proto_rawDescGZIP(), []int{9}
}
...
func (x *SentinelLibraryAppBinaryFile) Reset() {
	*x = SentinelLibraryAppBinaryFile{}
	mi := &file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SentinelLibraryAppBinaryFile) Descriptor() ([]byte, []int) {
	return file_librarian_sephirah_v1_sentinel_sentinel_service_proto_rawDescGZIP(), []int{10}
}
...
const file_librarian_sephirah_v1_sentinel_sentinel_service_proto_rawDesc = "" +
	"\n" +
	"5librarian/sephirah/v1/sentinel/sentinel_service.proto\x12\x1elibrarian.sephirah.v1.sentinel\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x15\n" +
	...
	"!ReportSentinelInformationResponse\"\x91\x02\n" +
	"\x18ReportAppBinariesRequest\x12[\n" +
	"\fapp_binaries\x18\x01 \x03(\v28.librarian.sephirah.v1.sentinel.SentinelLibraryAppBinaryR\vappBinaries\x12D\n" +
...
var file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_librarian_sephirah_v1_sentinel_sentinel_service_proto_goTypes = []any{
	...
	(*HeartbeatRequest)(nil),                  // 2: librarian.sephirah.v1.sentinel.HeartbeatRequest
	(*HeartbeatResponse)(nil),                 // 3: librarian.sephirah.v1.sentinel.HeartbeatResponse
	(*ReportSentinelInformationRequest)(nil),  // 4: librarian.sephirah.v1.sentinel.ReportSentinelInformationRequest
	(*ReportSentinelInformationResponse)(nil), // 5: librarian.sephirah.v1.sentinel.ReportSentinelInformationResponse
	(*ReportAppBinariesRequest)(nil),          // 6: librarian.sephirah.v1.sentinel.ReportAppBinariesRequest
	(*ReportAppBinariesResponse)(nil),         // 7: librarian.sephirah.v1.sentinel.ReportAppBinariesResponse
	(*SentinelLibrary)(nil),                   // 8: librarian.sephirah.v1.sentinel.SentinelLibrary
	(*SentinelLibraryAppBinary)(nil),          // 9: librarian.sephirah.v1.sentinel.SentinelLibraryAppBinary
	(*SentinelLibraryAppBinaryFile)(nil),      // 10: librarian.sephirah.v1.sentinel.SentinelLibraryAppBinaryFile
	(*timestamppb.Timestamp)(nil),             // 11: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),               // 12: google.protobuf.Duration
}
var file_librarian_sephirah_v1_sentinel_sentinel_service_proto_depIdxs = []int32{
	11, // 0: librarian.sephirah.v1.sentinel.HeartbeatRequest.client_time:type_name -> google.protobuf.Timestamp
	12, // 1: librarian.sephirah.v1.sentinel.HeartbeatRequest.heartbeat_interval:type_name -> google.protobuf.Duration
	12, // 2: librarian.sephirah.v1.sentinel.HeartbeatRequest.commit_snapshot_interval:type_name -> google.protobuf.Duration
	8,  // 3: librarian.sephirah.v1.sentinel.ReportSentinelInformationRequest.libraries:type_name -> librarian.sephirah.v1.sentinel.SentinelLibrary
	9,  // 4: librarian.sephirah.v1.sentinel.ReportAppBinariesRequest.app_binaries:type_name -> librarian.sephirah.v1.sentinel.SentinelLibraryAppBinary
	11, // 5: librarian.sephirah.v1.sentinel.ReportAppBinariesRequest.snapshot_time:type_name -> google.protobuf.Timestamp
	10, // 6: librarian.sephirah.v1.sentinel.SentinelLibraryAppBinary.files:type_name -> librarian.sephirah.v1.sentinel.SentinelLibraryAppBinaryFile
	0,  // 7: librarian.sephirah.v1.sentinel.LibrarianSentinelService.RefreshToken:input_type -> librarian.sephirah.v1.sentinel.RefreshTokenRequest
	2,  // 8: librarian.sephirah.v1.sentinel.LibrarianSentinelService.Heartbeat:input_type -> librarian.sephirah.v1.sentinel.HeartbeatRequest
	4,  // 9: librarian.sephirah.v1.sentinel.LibrarianSentinelService.ReportSentinelInformation:input_type -> librarian.sephirah.v1.sentinel.ReportSentinelInformationRequest
	6,  // 10: librarian.sephirah.v1.sentinel.LibrarianSentinelService.ReportAppBinaries:input_type -> librarian.sephirah.v1.sentinel.ReportAppBinariesRequest
	1,  // 11: librarian.sephirah.v1.sentinel.LibrarianSentinelService.RefreshToken:output_type -> librarian.sephirah.v1.sentinel.RefreshTokenResponse
	3,  // 12: librarian.sephirah.v1.sentinel.LibrarianSentinelService.Heartbeat:output_type -> librarian.sephirah.v1.sentinel.HeartbeatResponse
	5,  // 13: librarian.sephirah.v1.sentinel.LibrarianSentinelService.ReportSentinelInformation:output_type -> librarian.sephirah.v1.sentinel.ReportSentinelInformationResponse
	7,  // 14: librarian.sephirah.v1.sentinel.LibrarianSentinelService.ReportAppBinaries:output_type -> librarian.sephirah.v1.sentinel.ReportAppBinariesResponse
...
func file_librarian_sephirah_v1_sentinel_sentinel_service_proto_init() {
	...
	file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes[6].OneofWrappers = []any{}
	file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes[7].OneofWrappers = []any{}
	file_librarian_sephirah_v1_sentinel_sentinel_service_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
