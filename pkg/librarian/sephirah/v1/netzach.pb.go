...
const file_librarian_sephirah_v1_netzach_proto_rawDesc = "" +
	"\n" +
	"#librarian/sephirah/v1/netzach.proto\x12\x15librarian.sephirah.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1clibrarian/v1/wellknown.proto\"X\n" +
	"\x19CreateNotifyTargetRequest\x12;\n" +
	"\x06target\x18\x01 \x01(\v2#.librarian.sephirah.v1.NotifyTargetR\x06target\"F\n" +
	"\x1aCreateNotifyTargetResponse\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\"X\n" +
	"\x19UpdateNotifyTargetRequest\x12;\n" +
	"\x06target\x18\x01 \x01(\v2#.librarian.sephirah.v1.NotifyTargetR\x06target\"\x1c\n" +
	"\x1aUpdateNotifyTargetResponse\"\xd6\x01\n" +
	"\x18ListNotifyTargetsRequest\x123\n" +
	"\x06paging\x18\x01 \x01(\v2\x1b.librarian.v1.PagingRequestR\x06paging\x125\n" +
	"\tid_filter\x18\x02 \x03(\v2\x18.librarian.v1.InternalIDR\bidFilter\x12N\n" +
	"\rstatus_filter\x18\x04 \x03(\x0e2).librarian.sephirah.v1.NotifyTargetStatusR\fstatusFilter\"\x90\x01\n" +
	"\x19ListNotifyTargetsResponse\x124\n" +
	"\x06paging\x18\x01 \x01(\v2\x1c.librarian.v1.PagingResponseR\x06paging\x12=\n" +
	"\atargets\x18\x02 \x03(\v2#.librarian.sephirah.v1.NotifyTargetR\atargets\"P\n" +
	"\x17CreateNotifyFlowRequest\x125\n" +
	"\x04flow\x18\x01 \x01(\v2!.librarian.sephirah.v1.NotifyFlowR\x04flow\"D\n" +
	"\x18CreateNotifyFlowResponse\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\"P\n" +
	"\x17UpdateNotifyFlowRequest\x125\n" +
	"\x04flow\x18\x01 \x01(\v2!.librarian.sephirah.v1.NotifyFlowR\x04flow\"\x1a\n" +
	"\x18UpdateNotifyFlowResponse\"\x84\x01\n" +
	"\x16ListNotifyFlowsRequest\x123\n" +
	"\x06paging\x18\x01 \x01(\v2\x1b.librarian.v1.PagingRequestR\x06paging\x125\n" +
	"\tid_filter\x18\x02 \x03(\v2\x18.librarian.v1.InternalIDR\bidFilter\"\x88\x01\n" +
	"\x17ListNotifyFlowsResponse\x124\n" +
	"\x06paging\x18\x01 \x01(\v2\x1c.librarian.v1.PagingResponseR\x06paging\x127\n" +
	"\x05flows\x18\x02 \x03(\v2!.librarian.sephirah.v1.NotifyFlowR\x05flows\"\xf1\x01\n" +
	"\fNotifyTarget\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12>\n" +
	"\vdestination\x18\x04 \x01(\v2\x1c.librarian.v1.FeatureRequestR\vdestination\x12A\n" +
	"\x06status\x18\x05 \x01(\x0e2).librarian.sephirah.v1.NotifyTargetStatusR\x06status\"\xb3\x02\n" +
	"\n" +
	"NotifyFlow\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12A\n" +
	"\asources\x18\x04 \x03(\v2'.librarian.sephirah.v1.NotifyFlowSourceR\asources\x12A\n" +
	"\atargets\x18\x05 \x03(\v2'.librarian.sephirah.v1.NotifyFlowTargetR\atargets\x12?\n" +
	"\x06status\x18\x06 \x01(\x0e2'.librarian.sephirah.v1.NotifyFlowStatusR\x06status\"\x86\x01\n" +
	"\x10NotifyFlowSource\x12;\n" +
	"\x06filter\x18\x01 \x01(\v2#.librarian.sephirah.v1.NotifyFilterR\x06filter\x125\n" +
	"\tsource_id\x18\x02 \x01(\v2\x18.librarian.v1.InternalIDR\bsourceId\"\x86\x01\n" +
	"\x10NotifyFlowTarget\x12;\n" +
	"\x06filter\x18\x01 \x01(\v2#.librarian.sephirah.v1.NotifyFilterR\x06filter\x125\n" +
	...
	"\x10include_keywords\x18\x02 \x03(\tR\x0fincludeKeywords\"\xfe\x01\n" +
	"\x1eListSystemNotificationsRequest\x123\n" +
	"\x06paging\x18\x01 \x01(\v2\x1b.librarian.v1.PagingRequestR\x06paging\x12Q\n" +
	"\flevel_filter\x18\x03 \x03(\x0e2..librarian.sephirah.v1.SystemNotificationLevelR\vlevelFilter\x12T\n" +
	"\rstatus_filter\x18\x04 \x03(\x0e2/.librarian.sephirah.v1.SystemNotificationStatusR\fstatusFilter\"\xa8\x01\n" +
	"\x1fListSystemNotificationsResponse\x124\n" +
	"\x06paging\x18\x01 \x01(\v2\x1c.librarian.v1.PagingResponseR\x06paging\x12O\n" +
	"\rnotifications\x18\x02 \x03(\v2).librarian.sephirah.v1.SystemNotificationR\rnotifications\"\x94\x01\n" +
	"\x1fUpdateSystemNotificationRequest\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\x12G\n" +
	"\x06status\x18\x02 \x01(\x0e2/.librarian.sephirah.v1.SystemNotificationStatusR\x06status\"\"\n" +
	" UpdateSystemNotificationResponse\"\xf7\x02\n" +
	"\x12SystemNotification\x12(\n" +
	"\x02id\x18\x01 \x01(\v2\x18.librarian.v1.InternalIDR\x02id\x12D\n" +
	"\x05level\x18\x03 \x01(\x0e2..librarian.sephirah.v1.SystemNotificationLevelR\x05level\x12G\n" +
	"\x06status\x18\x04 \x01(\x0e2/.librarian.sephirah.v1.SystemNotificationStatusR\x06status\x12\x14\n" +
	...
	"$SYSTEM_NOTIFICATION_STATUS_DISMISSED\x10\x03B]Z5github.com/tuihub/protos/pkg/librarian/sephirah/v1;v1\xaa\x02#TuiHub.Protos.Librarian.Sephirah.V1b\x06proto3"
...
var file_librarian_sephirah_v1_netzach_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_librarian_sephirah_v1_netzach_proto_goTypes = []any{
	...
	(SystemNotificationStatus)(0),            // 3: librarian.sephirah.v1.SystemNotificationStatus
	(*CreateNotifyTargetRequest)(nil),        // 4: librarian.sephirah.v1.CreateNotifyTargetRequest
	(*CreateNotifyTargetResponse)(nil),       // 5: librarian.sephirah.v1.CreateNotifyTargetResponse
	(*UpdateNotifyTargetRequest)(nil),        // 6: librarian.sephirah.v1.UpdateNotifyTargetRequest
	(*UpdateNotifyTargetResponse)(nil),       // 7: librarian.sephirah.v1.UpdateNotifyTargetResponse
	(*ListNotifyTargetsRequest)(nil),         // 8: librarian.sephirah.v1.ListNotifyTargetsRequest
	(*ListNotifyTargetsResponse)(nil),        // 9: librarian.sephirah.v1.ListNotifyTargetsResponse
	(*CreateNotifyFlowRequest)(nil),          // 10: librarian.sephirah.v1.CreateNotifyFlowRequest
	(*CreateNotifyFlowResponse)(nil),         // 11: librarian.sephirah.v1.CreateNotifyFlowResponse
	(*UpdateNotifyFlowRequest)(nil),          // 12: librarian.sephirah.v1.UpdateNotifyFlowRequest
	(*UpdateNotifyFlowResponse)(nil),         // 13: librarian.sephirah.v1.UpdateNotifyFlowResponse
	(*ListNotifyFlowsRequest)(nil),           // 14: librarian.sephirah.v1.ListNotifyFlowsRequest
	(*ListNotifyFlowsResponse)(nil),          // 15: librarian.sephirah.v1.ListNotifyFlowsResponse
	(*NotifyTarget)(nil),                     // 16: librarian.sephirah.v1.NotifyTarget
	(*NotifyFlow)(nil),                       // 17: librarian.sephirah.v1.NotifyFlow
	(*NotifyFlowSource)(nil),                 // 18: librarian.sephirah.v1.NotifyFlowSource
	(*NotifyFlowTarget)(nil),                 // 19: librarian.sephirah.v1.NotifyFlowTarget
	(*NotifyFilter)(nil),                     // 20: librarian.sephirah.v1.NotifyFilter
	(*ListSystemNotificationsRequest)(nil),   // 21: librarian.sephirah.v1.ListSystemNotificationsRequest
	(*ListSystemNotificationsResponse)(nil),  // 22: librarian.sephirah.v1.ListSystemNotificationsResponse
	(*UpdateSystemNotificationRequest)(nil),  // 23: librarian.sephirah.v1.UpdateSystemNotificationRequest
	(*UpdateSystemNotificationResponse)(nil), // 24: librarian.sephirah.v1.UpdateSystemNotificationResponse
	(*SystemNotification)(nil),               // 25: librarian.sephirah.v1.SystemNotification
...
var file_librarian_sephirah_v1_netzach_proto_depIdxs = []int32{
	16, // 0: librarian.sephirah.v1.CreateNotifyTargetRequest.target:type_name -> librarian.sephirah.v1.NotifyTarget
	26, // 1: librarian.sephirah.v1.CreateNotifyTargetResponse.id:type_name -> librarian.v1.InternalID
	16, // 2: librarian.sephirah.v1.UpdateNotifyTargetRequest.target:type_name -> librarian.sephirah.v1.NotifyTarget
	27, // 3: librarian.sephirah.v1.ListNotifyTargetsRequest.paging:type_name -> librarian.v1.PagingRequest
	26, // 4: librarian.sephirah.v1.ListNotifyTargetsRequest.id_filter:type_name -> librarian.v1.InternalID
	0,  // 5: librarian.sephirah.v1.ListNotifyTargetsRequest.status_filter:type_name -> librarian.sephirah.v1.NotifyTargetStatus
	28, // 6: librarian.sephirah.v1.ListNotifyTargetsResponse.paging:type_name -> librarian.v1.PagingResponse
	16, // 7: librarian.sephirah.v1.ListNotifyTargetsResponse.targets:type_name -> librarian.sephirah.v1.NotifyTarget
	17, // 8: librarian.sephirah.v1.CreateNotifyFlowRequest.flow:type_name -> librarian.sephirah.v1.NotifyFlow
	26, // 9: librarian.sephirah.v1.CreateNotifyFlowResponse.id:type_name -> librarian.v1.InternalID
	17, // 10: librarian.sephirah.v1.UpdateNotifyFlowRequest.flow:type_name -> librarian.sephirah.v1.NotifyFlow
	27, // 11: librarian.sephirah.v1.ListNotifyFlowsRequest.paging:type_name -> librarian.v1.PagingRequest
	26, // 12: librarian.sephirah.v1.ListNotifyFlowsRequest.id_filter:type_name -> librarian.v1.InternalID
	28, // 13: librarian.sephirah.v1.ListNotifyFlowsResponse.paging:type_name -> librarian.v1.PagingResponse
	17, // 14: librarian.sephirah.v1.ListNotifyFlowsResponse.flows:type_name -> librarian.sephirah.v1.NotifyFlow
	26, // 15: librarian.sephirah.v1.NotifyTarget.id:type_name -> librarian.v1.InternalID
	29, // 16: librarian.sephirah.v1.NotifyTarget.destination:type_name -> librarian.v1.FeatureRequest
	0,  // 17: librarian.sephirah.v1.NotifyTarget.status:type_name -> librarian.sephirah.v1.NotifyTargetStatus
	26, // 18: librarian.sephirah.v1.NotifyFlow.id:type_name -> librarian.v1.InternalID
	18, // 19: librarian.sephirah.v1.NotifyFlow.sources:type_name -> librarian.sephirah.v1.NotifyFlowSource
	19, // 20: librarian.sephirah.v1.NotifyFlow.targets:type_name -> librarian.sephirah.v1.NotifyFlowTarget
	1,  // 21: librarian.sephirah.v1.NotifyFlow.status:type_name -> librarian.sephirah.v1.NotifyFlowStatus
	20, // 22: librarian.sephirah.v1.NotifyFlowSource.filter:type_name -> librarian.sephirah.v1.NotifyFilter
	26, // 23: librarian.sephirah.v1.NotifyFlowSource.source_id:type_name -> librarian.v1.InternalID
	20, // 24: librarian.sephirah.v1.NotifyFlowTarget.filter:type_name -> librarian.sephirah.v1.NotifyFilter
	26, // 25: librarian.sephirah.v1.NotifyFlowTarget.target_id:type_name -> librarian.v1.InternalID
	27, // 26: librarian.sephirah.v1.ListSystemNotificationsRequest.paging:type_name -> librarian.v1.PagingRequest
	...
	3,  // 28: librarian.sephirah.v1.ListSystemNotificationsRequest.status_filter:type_name -> librarian.sephirah.v1.SystemNotificationStatus
	28, // 29: librarian.sephirah.v1.ListSystemNotificationsResponse.paging:type_name -> librarian.v1.PagingResponse
	25, // 30: librarian.sephirah.v1.ListSystemNotificationsResponse.notifications:type_name -> librarian.sephirah.v1.SystemNotification
	26, // 31: librarian.sephirah.v1.UpdateSystemNotificationRequest.id:type_name -> librarian.v1.InternalID
	3,  // 32: librarian.sephirah.v1.UpdateSystemNotificationRequest.status:type_name -> librarian.sephirah.v1.SystemNotificationStatus
	26, // 33: librarian.sephirah.v1.SystemNotification.id:type_name -> librarian.v1.InternalID
	2,  // 34: librarian.sephirah.v1.SystemNotification.level:type_name -> librarian.sephirah.v1.SystemNotificationLevel
	3,  // 35: librarian.sephirah.v1.SystemNotification.status:type_name -> librarian.sephirah.v1.SystemNotificationStatus
	30, // 36: librarian.sephirah.v1.SystemNotification.create_time:type_name -> google.protobuf.Timestamp
	30, // 37: librarian.sephirah.v1.SystemNotification.update_time:type_name -> google.protobuf.Timestamp
