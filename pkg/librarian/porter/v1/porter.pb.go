...
var file_librarian_porter_v1_porter_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x72, 0x0a, 0x18, 0x50, 0x72, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50,
	...
	0x74, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x36, 0x0a, 0x19, 0x50, 0x72, 0x65, 0x73, 0x69, 0x67,
...
var file_librarian_porter_v1_porter_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_librarian_porter_v1_porter_proto_goTypes = []interface{}{
	...
	nil,                                    // 27: librarian.porter.v1.PullDBResponse.DataEntry
	(*PushDataRequest_DataMeta)(nil),       // 28: librarian.porter.v1.PushDataRequest.DataMeta
	(*v1.Feed)(nil),                        // 29: librarian.v1.Feed
	(*v1.FeedItem)(nil),                    // 30: librarian.v1.FeedItem
	(*v1.AccountID)(nil),                   // 31: librarian.v1.AccountID
	(*v1.Account)(nil),                     // 32: librarian.v1.Account
	(*v1.AppID)(nil),                       // 33: librarian.v1.AppID
	(*v1.App)(nil),                         // 34: librarian.v1.App
}
var file_librarian_porter_v1_porter_proto_depIdxs = []int32{
	...
	29, // 1: librarian.porter.v1.PullFeedResponse.data:type_name -> librarian.v1.Feed
	3,  // 2: librarian.porter.v1.PushFeedItemsRequest.destination:type_name -> librarian.porter.v1.FeedDestination
	30, // 3: librarian.porter.v1.PushFeedItemsRequest.items:type_name -> librarian.v1.FeedItem
	4,  // 4: librarian.porter.v1.PullDBRequest.source:type_name -> librarian.porter.v1.DBSource
	27, // 5: librarian.porter.v1.PullDBResponse.data:type_name -> librarian.porter.v1.PullDBResponse.DataEntry
	...
	31, // 8: librarian.porter.v1.PullAccountRequest.account_id:type_name -> librarian.v1.AccountID
	32, // 9: librarian.porter.v1.PullAccountResponse.account:type_name -> librarian.v1.Account
	33, // 10: librarian.porter.v1.PullAppRequest.app_id:type_name -> librarian.v1.AppID
	34, // 11: librarian.porter.v1.PullAppResponse.app:type_name -> librarian.v1.App
	...
	31, // 13: librarian.porter.v1.PullAccountAppRelationRequest.account_id:type_name -> librarian.v1.AccountID
	34, // 14: librarian.porter.v1.PullAccountAppRelationResponse.app_list:type_name -> librarian.v1.App
	28, // 15: librarian.porter.v1.PushDataRequest.metadata:type_name -> librarian.porter.v1.PushDataRequest.DataMeta
	6,  // 16: librarian.porter.v1.PresignedPullDataRequest.source:type_name -> librarian.porter.v1.DataSource
	6,  // 17: librarian.porter.v1.PushDataRequest.DataMeta.source:type_name -> librarian.porter.v1.DataSource
	7,  // 18: librarian.porter.v1.LibrarianPorterService.PullFeed:input_type -> librarian.porter.v1.PullFeedRequest
	9,  // 19: librarian.porter.v1.LibrarianPorterService.PushFeedItems:input_type -> librarian.porter.v1.PushFeedItemsRequest
	11, // 20: librarian.porter.v1.LibrarianPorterService.PullDB:input_type -> librarian.porter.v1.PullDBRequest
	17, // 21: librarian.porter.v1.LibrarianPorterService.PullAccount:input_type -> librarian.porter.v1.PullAccountRequest
	19, // 22: librarian.porter.v1.LibrarianPorterService.PullApp:input_type -> librarian.porter.v1.PullAppRequest
	21, // 23: librarian.porter.v1.LibrarianPorterService.PullAccountAppRelation:input_type -> librarian.porter.v1.PullAccountAppRelationRequest
	13, // 24: librarian.porter.v1.LibrarianPorterService.PullWiki:input_type -> librarian.porter.v1.PullWikiRequest
	15, // 25: librarian.porter.v1.LibrarianPorterService.PullData:input_type -> librarian.porter.v1.PullDataRequest
	23, // 26: librarian.porter.v1.LibrarianPorterService.PushData:input_type -> librarian.porter.v1.PushDataRequest
	25, // 27: librarian.porter.v1.LibrarianPorterService.PresignedPullData:input_type -> librarian.porter.v1.PresignedPullDataRequest
	8,  // 28: librarian.porter.v1.LibrarianPorterService.PullFeed:output_type -> librarian.porter.v1.PullFeedResponse
	10, // 29: librarian.porter.v1.LibrarianPorterService.PushFeedItems:output_type -> librarian.porter.v1.PushFeedItemsResponse
	12, // 30: librarian.porter.v1.LibrarianPorterService.PullDB:output_type -> librarian.porter.v1.PullDBResponse
	18, // 31: librarian.porter.v1.LibrarianPorterService.PullAccount:output_type -> librarian.porter.v1.PullAccountResponse
	20, // 32: librarian.porter.v1.LibrarianPorterService.PullApp:output_type -> librarian.porter.v1.PullAppResponse
	22, // 33: librarian.porter.v1.LibrarianPorterService.PullAccountAppRelation:output_type -> librarian.porter.v1.PullAccountAppRelationResponse
	14, // 34: librarian.porter.v1.LibrarianPorterService.PullWiki:output_type -> librarian.porter.v1.PullWikiResponse
	16, // 35: librarian.porter.v1.LibrarianPorterService.PullData:output_type -> librarian.porter.v1.PullDataResponse
	24, // 36: librarian.porter.v1.LibrarianPorterService.PushData:output_type -> librarian.porter.v1.PushDataResponse
	26, // 37: librarian.porter.v1.LibrarianPorterService.PresignedPullData:output_type -> librarian.porter.v1.PresignedPullDataResponse
