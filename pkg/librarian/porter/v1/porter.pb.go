...
var file_librarian_porter_v1_porter_proto_rawDesc = string([]byte{
...
var (
	...
	file_librarian_porter_v1_porter_proto_rawDescData []byte
)

func file_librarian_porter_v1_porter_proto_rawDescGZIP() []byte {
	file_librarian_porter_v1_porter_proto_rawDescOnce.Do(func() {
		file_librarian_porter_v1_porter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_librarian_porter_v1_porter_proto_rawDesc), len(file_librarian_porter_v1_porter_proto_rawDesc)))
	})
...
func file_librarian_porter_v1_porter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_librarian_porter_v1_porter_proto_rawDesc), len(file_librarian_porter_v1_porter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   31,
			NumExtensions: 0,
			NumServices:   1,
