...
const (
	LibrarianSephirahPorterService_RefreshToken_FullMethodName         = "/librarian.porter.v1.LibrarianSephirahPorterService/RefreshToken"
	LibrarianSephirahPorterService_AcquireUserToken_FullMethodName     = "/librarian.porter.v1.LibrarianSephirahPorterService/AcquireUserToken"
	LibrarianSephirahPorterService_GetNotifyTargetItems_FullMethodName = "/librarian.porter.v1.LibrarianSephirahPorterService/GetNotifyTargetItems"
	LibrarianSephirahPorterService_UpsertFeed_FullMethodName           = "/librarian.porter.v1.LibrarianSephirahPorterService/UpsertFeed"
	LibrarianSephirahPorterService_GetFeed_FullMethodName              = "/librarian.porter.v1.LibrarianSephirahPorterService/GetFeed"
)
...
func (UnimplementedLibrarianSephirahPorterServiceServer) AcquireUserToken(context.Context, *AcquireUserTokenRequest) (*AcquireUserTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AcquireUserToken not implemented")
}
func (UnimplementedLibrarianSephirahPorterServiceServer) GetNotifyTargetItems(context.Context, *GetNotifyTargetItemsRequest) (*GetNotifyTargetItemsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNotifyTargetItems not implemented")
}
func (UnimplementedLibrarianSephirahPorterServiceServer) UpsertFeed(context.Context, *UpsertFeedRequest) (*UpsertFeedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertFeed not implemented")
}
...
func RegisterLibrarianSephirahPorterServiceServer(s grpc.ServiceRegistrar, srv LibrarianSephirahPorterServiceServer) {
	// If the following call panics, it indicates UnimplementedLibrarianSephirahPorterServiceServer was
...
var LibrarianSephirahPorterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "librarian.porter.v1.LibrarianSephirahPorterService",
	...
	Metadata: "librarian/porter/v1/sephirah_porter_service.proto",
}
