...
func (x *AppPackageBinary) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
type Feed struct {
	...
	Image       []*FeedImage  `protobuf:"bytes,7,rep,name=image,proto3" json:"image,omitempty"`
...
type FeedItem struct {
	...
	Enclosure       []*FeedEnclosure       `protobuf:"bytes,13,rep,name=enclosure,proto3" json:"enclosure,omitempty"`
}
...
var file_librarian_v1_common_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x55, 0x72, 0x6c, 0x22, 0xa9,
	...
	0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x69,
	...
	0x6e, 0x52, 0x07, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x22, 0xc0, 0x04, 0x0a, 0x08, 0x46,
	...
	0x64, 0x50, 0x61, 0x72, 0x73, 0x65, 0x64, 0x88, 0x01, 0x01, 0x12, 0x39, 0x0a, 0x09, 0x65, 0x6e,
	0x63, 0x6c, 0x6f, 0x73, 0x75, 0x72, 0x65, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x65,
	0x64, 0x45, 0x6e, 0x63, 0x6c, 0x6f, 0x73, 0x75, 0x72, 0x65, 0x52, 0x09, 0x65, 0x6e, 0x63, 0x6c,
	0x6f, 0x73, 0x75, 0x72, 0x65, 0x42, 0x13, 0x0a, 0x11, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73,
...
var file_librarian_v1_common_proto_depIdxs = []int32{
	...
	6,  // 13: librarian.v1.Feed.id:type_name -> librarian.v1.InternalID
	15, // 14: librarian.v1.Feed.items:type_name -> librarian.v1.FeedItem
	17, // 15: librarian.v1.Feed.image:type_name -> librarian.v1.FeedImage
	16, // 16: librarian.v1.Feed.authors:type_name -> librarian.v1.FeedPerson
	6,  // 17: librarian.v1.FeedItem.id:type_name -> librarian.v1.InternalID
	16, // 18: librarian.v1.FeedItem.authors:type_name -> librarian.v1.FeedPerson
	17, // 19: librarian.v1.FeedItem.image:type_name -> librarian.v1.FeedImage
	19, // 20: librarian.v1.FeedItem.published_parsed:type_name -> google.protobuf.Timestamp
	19, // 21: librarian.v1.FeedItem.updated_parsed:type_name -> google.protobuf.Timestamp
	18, // 22: librarian.v1.FeedItem.enclosure:type_name -> librarian.v1.FeedEnclosure
