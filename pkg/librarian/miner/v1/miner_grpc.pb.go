...
func (c *librarianMinerServiceClient) RecognizeImageBinary(ctx context.Context, opts ...grpc.CallOption) (LibrarianMinerService_RecognizeImageBinaryClient, error) {
	stream, err := c.cc.NewStream(ctx, &LibrarianMinerService_ServiceDesc.Streams[0], LibrarianMinerService_RecognizeImageBinary_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &librarianMinerServiceRecognizeImageBinaryClient{stream}
	return x, nil
}
...
func (c *librarianMinerServiceClient) RecognizeImageURL(ctx context.Context, in *RecognizeImageURLRequest, opts ...grpc.CallOption) (*RecognizeImageURLResponse, error) {
	...
	err := c.cc.Invoke(ctx, LibrarianMinerService_RecognizeImageURL_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LibrarianMinerService_RecognizeImageBinary_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LibrarianMinerServiceServer).RecognizeImageBinary(&librarianMinerServiceRecognizeImageBinaryServer{stream})
}
