...
goog.exportSymbol('proto.librarian.porter.v1.SearchAppRequest', null, global);
goog.exportSymbol('proto.librarian.porter.v1.SearchAppResponse', null, global);
/**
 ...
 * @constructor
 */
proto.librarian.porter.v1.SearchAppRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.porter.v1.SearchAppRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.porter.v1.SearchAppRequest.displayName = 'proto.librarian.porter.v1.SearchAppRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.porter.v1.SearchAppResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.librarian.porter.v1.SearchAppResponse.repeatedFields_, null);
};
goog.inherits(proto.librarian.porter.v1.SearchAppResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.porter.v1.SearchAppResponse.displayName = 'proto.librarian.porter.v1.SearchAppResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.librarian.porter.v1.SearchAppRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.porter.v1.SearchAppRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.porter.v1.SearchAppRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.porter.v1.SearchAppRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.porter.v1.SearchAppRequest}
 */
proto.librarian.porter.v1.SearchAppRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.porter.v1.SearchAppRequest;
  return proto.librarian.porter.v1.SearchAppRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.porter.v1.SearchAppRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.porter.v1.SearchAppRequest}
 */
proto.librarian.porter.v1.SearchAppRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.porter.v1.SearchAppRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.porter.v1.SearchAppRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.porter.v1.SearchAppRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.porter.v1.SearchAppRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.librarian.porter.v1.SearchAppRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.librarian.porter.v1.SearchAppRequest} returns this
 */
proto.librarian.porter.v1.SearchAppRequest.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.librarian.porter.v1.SearchAppResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.librarian.porter.v1.SearchAppResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.porter.v1.SearchAppResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.porter.v1.SearchAppResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.porter.v1.SearchAppResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    appListList: jspb.Message.toObjectList(msg.getAppListList(),
    librarian_v1_common_pb.App.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.porter.v1.SearchAppResponse}
 */
proto.librarian.porter.v1.SearchAppResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.porter.v1.SearchAppResponse;
  return proto.librarian.porter.v1.SearchAppResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.porter.v1.SearchAppResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.porter.v1.SearchAppResponse}
 */
proto.librarian.porter.v1.SearchAppResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.porter.v1.SearchAppResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.porter.v1.SearchAppResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.porter.v1.SearchAppResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.porter.v1.SearchAppResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAppListList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.librarian.v1.App>}
 */
proto.librarian.porter.v1.SearchAppResponse.prototype.getAppListList = function() {
  return /** @type{!Array<!proto.librarian.v1.App>} */ (
    jspb.Message.getRepeatedWrapperField(this, librarian_v1_common_pb.App, 1));
};
...
/**
 * @param {!Array<!proto.librarian.v1.App>} value
 * @return {!proto.librarian.porter.v1.SearchAppResponse} returns this
*/
proto.librarian.porter.v1.SearchAppResponse.prototype.setAppListList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.v1.App}
 */
proto.librarian.porter.v1.SearchAppResponse.prototype.addAppList = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.librarian.v1.App, opt_index);
};
 ...
 * @return {!proto.librarian.porter.v1.SearchAppResponse} returns this
 */
proto.librarian.porter.v1.SearchAppResponse.prototype.clearAppListList = function() {
  return this.setAppListList([]);
};
