...
export interface ILibrarianSephirahServiceServer extends grpc.UntypedServiceImplementation {
  ...
  reportAppPackages: grpc.handleUnaryCall<librarian_sephirah_v1_gebura_pb.ReportAppPackagesRequest, librarian_sephirah_v1_gebura_pb.ReportAppPackagesResponse>;
...
export class LibrarianSephirahServiceClient extends grpc.Client {
  ...
  reportAppPackages(argument: librarian_sephirah_v1_gebura_pb.ReportAppPackagesRequest, callback: grpc.requestCallback<librarian_sephirah_v1_gebura_pb.ReportAppPackagesResponse>): grpc.ClientUnaryCall;
  reportAppPackages(argument: librarian_sephirah_v1_gebura_pb.ReportAppPackagesRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_gebura_pb.ReportAppPackagesResponse>): grpc.ClientUnaryCall;
  reportAppPackages(argument: librarian_sephirah_v1_gebura_pb.ReportAppPackagesRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_gebura_pb.ReportAppPackagesResponse>): grpc.ClientUnaryCall;
