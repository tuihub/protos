...
goog.exportSymbol('proto.librarian.sephirah.v1.sephirah.DeviceInfo', null, global);
...
goog.exportSymbol('proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest', null, global);
goog.exportSymbol('proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse', null, global);
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.displayName = 'proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.repeatedFields_, null);
};
goog.inherits(proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.displayName = 'proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.sephirah.DeviceInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.sephirah.DeviceInfo.displayName = 'proto.librarian.sephirah.v1.sephirah.DeviceInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.librarian.sephirah.v1.sephirah.RegisterDeviceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
deviceInfo: (f = msg.getDeviceInfo()) && proto.librarian.sephirah.v1.sephirah.DeviceInfo.toObject(includeInstance, f),
...
proto.librarian.sephirah.v1.sephirah.RegisterDeviceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.librarian.sephirah.v1.sephirah.DeviceInfo;
      reader.readMessage(value,proto.librarian.sephirah.v1.sephirah.DeviceInfo.deserializeBinaryFromReader);
...
proto.librarian.sephirah.v1.sephirah.RegisterDeviceRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.librarian.sephirah.v1.sephirah.DeviceInfo.serializeBinaryToWriter
    );
  }
  f = /** @type {string} */ (jspb.Message.getField(message, 2));
  if (f != null) {
 ...
 * @return {?proto.librarian.sephirah.v1.sephirah.DeviceInfo}
 */
proto.librarian.sephirah.v1.sephirah.RegisterDeviceRequest.prototype.getDeviceInfo = function() {
  return /** @type{?proto.librarian.sephirah.v1.sephirah.DeviceInfo} */ (
    jspb.Message.getWrapperField(this, proto.librarian.sephirah.v1.sephirah.DeviceInfo, 1));
};


/**
 * @param {?proto.librarian.sephirah.v1.sephirah.DeviceInfo|undefined} value
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest;
  return proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
devicesList: jspb.Message.toObjectList(msg.getDevicesList(),
    proto.librarian.sephirah.v1.sephirah.DeviceInfo.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse;
  return proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.librarian.sephirah.v1.sephirah.DeviceInfo>}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.getDevicesList = function() {
  return /** @type{!Array<!proto.librarian.sephirah.v1.sephirah.DeviceInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.librarian.sephirah.v1.sephirah.DeviceInfo, 1));
};


/**
 * @param {!Array<!proto.librarian.sephirah.v1.sephirah.DeviceInfo>} value
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse} returns this
*/
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.setDevicesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.librarian.sephirah.v1.sephirah.DeviceInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo}
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.addDevices = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.librarian.sephirah.v1.sephirah.DeviceInfo, opt_index);
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse} returns this
 */
proto.librarian.sephirah.v1.sephirah.ListRegisteredDevicesResponse.prototype.clearDevicesList = function() {
...
proto.librarian.sephirah.v1.sephirah.UserSession.prototype.getDeviceInfo = function() {
  return /** @type{?proto.librarian.sephirah.v1.sephirah.DeviceInfo} */ (
    jspb.Message.getWrapperField(this, proto.librarian.sephirah.v1.sephirah.DeviceInfo, 3));
};
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.sephirah.DeviceInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
deviceId: (f = msg.getDeviceId()) && librarian_v1_wellknown_pb.InternalID.toObject(includeInstance, f),
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.sephirah.DeviceInfo;
  return proto.librarian.sephirah.v1.sephirah.DeviceInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.sephirah.DeviceInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDeviceId();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.librarian.v1.InternalID}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getDeviceId = function() {
  return /** @type{?proto.librarian.v1.InternalID} */ (
    jspb.Message.getWrapperField(this, librarian_v1_wellknown_pb.InternalID, 1));
};
...
/**
 * @param {?proto.librarian.v1.InternalID|undefined} value
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
*/
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setDeviceId = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.clearDeviceId = function() {
  return this.setDeviceId(undefined);
};
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.hasDeviceId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getDeviceName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setDeviceName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getSystemType = function() {
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setSystemType = function(value) {
 ...
 * @return {string}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getSystemVersion = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setSystemVersion = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getClientName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setClientName = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getClientSourceCodeAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setClientSourceCodeAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.getClientVersion = function() {
 ...
 * @return {!proto.librarian.sephirah.v1.sephirah.DeviceInfo} returns this
 */
proto.librarian.sephirah.v1.sephirah.DeviceInfo.prototype.setClientVersion = function(value) {
