...
goog.exportSymbol('proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse', null, global);
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.displayName = 'proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.repeatedFields_, null);
};
goog.inherits(proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.displayName = 'proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest;
  return proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse;
  return proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.getCategoriesList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} returns this
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.setCategoriesList = function(value) {
 ...
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} returns this
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.addCategories = function(value, opt_index) {
 ...
 * @return {!proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse} returns this
 */
proto.librarian.sephirah.v1.ListFeedConfigCategoriesResponse.prototype.clearCategoriesList = function() {
