...
interface ILibrarianSentinelServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  heartbeat: grpc.MethodDefinition<librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatRequest, librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatResponse>;
...
export interface ILibrarianSentinelServiceServer extends grpc.UntypedServiceImplementation {
  ...
  heartbeat: grpc.handleUnaryCall<librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatRequest, librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatResponse>;
...
export class LibrarianSentinelServiceClient extends grpc.Client {
  ...
  heartbeat(argument: librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatRequest, callback: grpc.requestCallback<librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatResponse>): grpc.ClientUnaryCall;
  heartbeat(argument: librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatResponse>): grpc.ClientUnaryCall;
  heartbeat(argument: librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_sentinel_sentinel_service_pb.HeartbeatResponse>): grpc.ClientUnaryCall;
