...
import * as librarian_sephirah_v1_porter_sephirah_porter_service_pb from "../../../../librarian/sephirah/v1/porter/sephirah_porter_service_pb";
...
interface ILibrarianSephirahPorterServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  getFeed: grpc.MethodDefinition<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedRequest, librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedResponse>;
}
...
export interface ILibrarianSephirahPorterServiceServer extends grpc.UntypedServiceImplementation {
  ...
  getFeed: grpc.handleUnaryCall<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedRequest, librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedResponse>;
}
...
export class LibrarianSephirahPorterServiceClient extends grpc.Client {
  ...
  getNotifyTargetItems(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsRequest, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsResponse>): grpc.ClientUnaryCall;
  getNotifyTargetItems(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsResponse>): grpc.ClientUnaryCall;
  getNotifyTargetItems(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetNotifyTargetItemsResponse>): grpc.ClientUnaryCall;
  upsertFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedRequest, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedResponse>): grpc.ClientUnaryCall;
  upsertFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedResponse>): grpc.ClientUnaryCall;
  upsertFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.UpsertFeedResponse>): grpc.ClientUnaryCall;
  getFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedRequest, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedResponse>): grpc.ClientUnaryCall;
  getFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedResponse>): grpc.ClientUnaryCall;
  getFeed(argument: librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<librarian_sephirah_v1_porter_sephirah_porter_service_pb.GetFeedResponse>): grpc.ClientUnaryCall;
}
