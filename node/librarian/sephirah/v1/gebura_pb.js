...
goog.exportSymbol('proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest', null, global);
goog.exportSymbol('proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse', null, global);
...
goog.exportSymbol('proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest', null, global);
goog.exportSymbol('proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse', null, global);
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.displayName = 'proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.displayName = 'proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.repeatedFields_, null);
};
goog.inherits(proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.displayName = 'proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.displayName = 'proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse';
}
...
proto.librarian.sephirah.v1.ReportAppPackagesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    appPackageBinariesList: jspb.Message.toObjectList(msg.getAppPackageBinariesList(),
    librarian_v1_common_pb.AppPackageBinary.toObject, includeInstance)
  };
...
proto.librarian.sephirah.v1.ReportAppPackagesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      msg.addAppPackageBinaries(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.librarian.sephirah.v1.ReportAppPackagesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAppPackageBinariesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
 ...
 * @return {!Array<!proto.librarian.v1.AppPackageBinary>}
 */
proto.librarian.sephirah.v1.ReportAppPackagesRequest.prototype.getAppPackageBinariesList = function() {
  return /** @type{!Array<!proto.librarian.v1.AppPackageBinary>} */ (
    jspb.Message.getRepeatedWrapperField(this, librarian_v1_common_pb.AppPackageBinary, 1));
};


/**
 * @param {!Array<!proto.librarian.v1.AppPackageBinary>} value
 * @return {!proto.librarian.sephirah.v1.ReportAppPackagesRequest} returns this
*/
proto.librarian.sephirah.v1.ReportAppPackagesRequest.prototype.setAppPackageBinariesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.librarian.v1.AppPackageBinary=} opt_value
 * @param {number=} opt_index
 * @return {!proto.librarian.v1.AppPackageBinary}
 */
proto.librarian.sephirah.v1.ReportAppPackagesRequest.prototype.addAppPackageBinaries = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.librarian.v1.AppPackageBinary, opt_index);
};
 ...
 * @return {!proto.librarian.sephirah.v1.ReportAppPackagesRequest} returns this
 */
proto.librarian.sephirah.v1.ReportAppPackagesRequest.prototype.clearAppPackageBinariesList = function() {
  return this.setAppPackageBinariesList([]);
};
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    appPackageId: (f = msg.getAppPackageId()) && librarian_v1_common_pb.InternalID.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest;
  return proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAppPackageId();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.librarian.v1.InternalID}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.getAppPackageId = function() {
  return /** @type{?proto.librarian.v1.InternalID} */ (
    jspb.Message.getWrapperField(this, librarian_v1_common_pb.InternalID, 1));
};
...
/**
 * @param {?proto.librarian.v1.InternalID|undefined} value
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest} returns this
*/
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.setAppPackageId = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest} returns this
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.clearAppPackageId = function() {
  return this.setAppPackageId(undefined);
};
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeRequest.prototype.hasAppPackageId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse;
  return proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.getDuration = function() {
 ...
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse} returns this
*/
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.setDuration = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse} returns this
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.clearDuration = function() {
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.GetAppPackageRunTimeResponse.prototype.hasDuration = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {?proto.librarian.v1.PagingRequest}
 */
proto.librarian.sephirah.v1.ListGameSaveFilesRequest.prototype.getPaging = function() {
  return /** @type{?proto.librarian.v1.PagingRequest} */ (
    jspb.Message.getWrapperField(this, librarian_v1_common_pb.PagingRequest, 1));
};
...
*/
proto.librarian.sephirah.v1.ListGameSaveFilesRequest.prototype.setPaging = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.ListGameSaveFilesRequest} returns this
 */
proto.librarian.sephirah.v1.ListGameSaveFilesRequest.prototype.clearPaging = function() {
  return this.setPaging(undefined);
};
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.ListGameSaveFilesRequest.prototype.hasPaging = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @const
 */
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.repeatedFields_ = [2];
 ...
 * @return {?proto.librarian.v1.PagingResponse}
 */
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.getPaging = function() {
  return /** @type{?proto.librarian.v1.PagingResponse} */ (
    jspb.Message.getWrapperField(this, librarian_v1_common_pb.PagingResponse, 1));
};
...
*/
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.setPaging = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.ListGameSaveFilesResponse} returns this
 */
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.clearPaging = function() {
  return this.setPaging(undefined);
};
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.hasPaging = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.librarian.sephirah.v1.ListGameSaveFilesResponse.Result>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.librarian.sephirah.v1.ListGameSaveFilesResponse.Result, 2));
};
...
proto.librarian.sephirah.v1.ListGameSaveFilesResponse.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.librarian.sephirah.v1.ListGameSaveFilesResponse.Result, opt_index);
};
 ...
 * @const
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    appId: (f = msg.getAppId()) && librarian_v1_common_pb.InternalID.toObject(includeInstance, f),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest;
  return proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAppId();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.librarian.v1.InternalID}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.getAppId = function() {
  return /** @type{?proto.librarian.v1.InternalID} */ (
    jspb.Message.getWrapperField(this, librarian_v1_common_pb.InternalID, 1));
};
...
/**
 * @param {?proto.librarian.v1.InternalID|undefined} value
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} returns this
*/
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.setAppId = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} returns this
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.clearAppId = function() {
  return this.setAppId(undefined);
};
 ...
 * @return {boolean}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.hasAppId = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * repeated librarian.v1.InternalID app_category_ids = 2;
 * @return {!Array<!proto.librarian.v1.InternalID>}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.getAppCategoryIdsList = function() {
  return /** @type{!Array<!proto.librarian.v1.InternalID>} */ (
 ...
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} returns this
*/
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.setAppCategoryIdsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.librarian.v1.InternalID}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.addAppCategoryIds = function(opt_value, opt_index) {
 ...
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest} returns this
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesRequest.prototype.clearAppCategoryIdsList = function() {
 ...
 * @return {!Object}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse;
  return proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.librarian.sephirah.v1.UpdateAppAppCategoriesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
