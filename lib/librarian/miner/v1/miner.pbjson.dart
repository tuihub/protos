...
final $typed_data.Uint8List recognizeImageBinaryRequestDescriptor =
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.miner.v1.RecognizeImageResult',
      '10': 'results'
    },
  ],
};
...
final $typed_data.Uint8List recognizeImageBinaryResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List recognizeImageURLRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List recognizeImageURLResponseDescriptor =
    $convert.base64Decode(
