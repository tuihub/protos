...
class LibrarianPorterServiceClient extends $grpc.Client {
  ...
  static final _$pullDB = $grpc.ClientMethod<$0.PullDBRequest, $0.PullDBResponse>(
  ...
  static final _$pullWiki = $grpc.ClientMethod<$0.PullWikiRequest, $0.PullWikiResponse>(
      '/librarian.porter.v1.LibrarianPorterService/PullWiki',
      ($0.PullWikiRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PullWikiResponse.fromBuffer(value));
  static final _$pullData = $grpc.ClientMethod<$0.PullDataRequest, $0.PullDataResponse>(
      '/librarian.porter.v1.LibrarianPorterService/PullData',
      ($0.PullDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PullDataResponse.fromBuffer(value));
  static final _$pushData = $grpc.ClientMethod<$0.PushDataRequest, $0.PushDataResponse>(
      '/librarian.porter.v1.LibrarianPorterService/PushData',
      ($0.PushDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PushDataResponse.fromBuffer(value));
  static final _$presignedPullData = $grpc.ClientMethod<$0.PresignedPullDataRequest, $0.PresignedPullDataResponse>(
      '/librarian.porter.v1.LibrarianPorterService/PresignedPullData',
      ($0.PresignedPullDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PresignedPullDataResponse.fromBuffer(value));
  static final _$presignedPushData = $grpc.ClientMethod<$0.PresignedPushDataRequest, $0.PresignedPushDataResponse>(
      '/librarian.porter.v1.LibrarianPorterService/PresignedPushData',
      ($0.PresignedPushDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PresignedPushDataResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.PullDBResponse> pullDB($0.PullDBRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.PullWikiResponse> pullWiki($0.PullWikiRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$pullWiki, request, options: options);
  }

  $grpc.ResponseStream<$0.PullDataResponse> pullData($0.PullDataRequest request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$pullData, $async.Stream.fromIterable([request]), options: options);
  }

  $grpc.ResponseFuture<$0.PushDataResponse> pushData($async.Stream<$0.PushDataRequest> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$pushData, request, options: options).single;
  }

  $grpc.ResponseFuture<$0.PresignedPullDataResponse> presignedPullData($0.PresignedPullDataRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$presignedPullData, request, options: options);
  }

  $grpc.ResponseFuture<$0.PresignedPushDataResponse> presignedPushData($0.PresignedPushDataRequest request, {$grpc.CallOptions? options}) {
...
abstract class LibrarianPorterServiceBase extends $grpc.Service {
  ...
  LibrarianPorterServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.PresignedPullDataRequest, $0.PresignedPullDataResponse>(
        'PresignedPullData',
        presignedPullData_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PresignedPullDataRequest.fromBuffer(value),
        ($0.PresignedPullDataResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.PresignedPushDataRequest, $0.PresignedPushDataResponse>(
        'PresignedPushData',
        presignedPushData_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PresignedPushDataRequest.fromBuffer(value),
  ...
  $async.Future<$0.PullDBResponse> pullDB_Pre($grpc.ServiceCall call, $async.Future<$0.PullDBRequest> request) async {
  ...
  $async.Future<$0.PullWikiResponse> pullWiki_Pre($grpc.ServiceCall call, $async.Future<$0.PullWikiRequest> request) async {
    return pullWiki(call, await request);
  }

  $async.Stream<$0.PullDataResponse> pullData_Pre($grpc.ServiceCall call, $async.Future<$0.PullDataRequest> request) async* {
    yield* pullData(call, await request);
  }

  $async.Future<$0.PresignedPullDataResponse> presignedPullData_Pre($grpc.ServiceCall call, $async.Future<$0.PresignedPullDataRequest> request) async {
    return presignedPullData(call, await request);
  }

  $async.Future<$0.PresignedPushDataResponse> presignedPushData_Pre($grpc.ServiceCall call, $async.Future<$0.PresignedPushDataRequest> request) async {
  ...
  $async.Future<$0.PullDBResponse> pullDB($grpc.ServiceCall call, $0.PullDBRequest request);
  ...
  $async.Future<$0.PullWikiResponse> pullWiki($grpc.ServiceCall call, $0.PullWikiRequest request);
  $async.Stream<$0.PullDataResponse> pullData($grpc.ServiceCall call, $0.PullDataRequest request);
  $async.Future<$0.PushDataResponse> pushData($grpc.ServiceCall call, $async.Stream<$0.PushDataRequest> request);
  $async.Future<$0.PresignedPullDataResponse> presignedPullData($grpc.ServiceCall call, $0.PresignedPullDataRequest request);
  $async.Future<$0.PresignedPushDataResponse> presignedPushData($grpc.ServiceCall call, $0.PresignedPushDataRequest request);
}
