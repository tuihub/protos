...
const FeedItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'read_count', '3': 15, '4': 1, '5': 3, '10': 'readCount'},
  ],
  '8': const [
...
final $typed_data.Uint8List feedItemDescriptor = $convert.base64Decode('');
