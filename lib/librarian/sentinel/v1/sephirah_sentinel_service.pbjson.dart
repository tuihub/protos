...
const ReportSentinelInformationRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sentinel.v1.SentinelLibrary',
      '10': 'libraries'
    },
  ],
};
...
final $typed_data.Uint8List reportSentinelInformationRequestDescriptor = $convert.base64Decode(
    ...
    'IUZG93bmxvYWRGaWxlQmFzZVBhdGgSRAoJbGlicmFyaWVzGAUgAygLMiYubGlicmFyaWFuLnNl'
    'bnRpbmVsLnYxLlNlbnRpbmVsTGlicmFyeVIJbGlicmFyaWVz');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sentinel.v1.SentinelLibraryAppBinary',
      '10': 'appBinaries'
    },
    {
      '1': 'snapshot_time',
...
final $typed_data.Uint8List reportAppBinariesRequestDescriptor = $convert.base64Decode(
    'ChhSZXBvcnRBcHBCaW5hcmllc1JlcXVlc3QSUgoMYXBwX2JpbmFyaWVzGAEgAygLMi8ubGlicm'
    'FyaWFuLnNlbnRpbmVsLnYxLlNlbnRpbmVsTGlicmFyeUFwcEJpbmFyeVILYXBwQmluYXJpZXMS'
    'RAoNc25hcHNob3RfdGltZRgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBIAFIMc2'
    '5hcHNob3RUaW1liAEBEiwKD2NvbW1pdF9zbmFwc2hvdBgDIAEoCEgBUg5jb21taXRTbmFwc2hv'
    'dIgBAUIQCg5fc25hcHNob3RfdGltZUISChBfY29tbWl0X3NuYXBzaG90');
...
const SentinelLibraryAppBinary$json = {
  ...
  '2': [
    ...
    {'1': 'need_token', '3': 4, '4': 1, '5': 8, '10': 'needToken'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sentinel.v1.SentinelLibraryAppBinaryFile',
      '10': 'files'
    },
...
final $typed_data.Uint8List sentinelLibraryAppBinaryDescriptor = $convert.base64Decode(
    ...
    'Rva2VuGAQgASgIUgluZWVkVG9rZW4SSQoFZmlsZXMYBSADKAsyMy5saWJyYXJpYW4uc2VudGlu'
    'ZWwudjEuU2VudGluZWxMaWJyYXJ5QXBwQmluYXJ5RmlsZVIFZmlsZXMSEgoEbmFtZRgKIAEoCV'
    'IEbmFtZRIYCgd2ZXJzaW9uGAsgASgJUgd2ZXJzaW9uEhwKCWRldmVsb3BlchgMIAEoCVIJZGV2'
    'ZWxvcGVyEhwKCXB1Ymxpc2hlchgNIAEoCVIJcHVibGlzaGVy');
