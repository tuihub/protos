  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.FeedConfig',
      '10': 'config'
    },
  ],
};
...
const ListFeedConfigsRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.FeedConfigStatus',
      '10': 'statusFilter'
    },
...
const ListFeedConfigsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.ListFeedConfigsResponse.FeedWithConfig',
      '10': 'feedsWithConfig'
    },
  ],
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.FeedActionSet',
      '10': 'actionSet'
    },
  ],
};
...
final $typed_data.Uint8List createFeedActionSetRequestDescriptor =
    $convert.base64Decode(
        'ChpDcmVhdGVGZWVkQWN0aW9uU2V0UmVxdWVzdBJDCgphY3Rpb25fc2V0GAEgASgLMiQubGlicm'
        'FyaWFuLnNlcGhpcmFoLnYxLkZlZWRBY3Rpb25TZXRSCWFjdGlvblNldA==');
...
final $typed_data.Uint8List updateFeedActionSetRequestDescriptor =
    $convert.base64Decode(
        'ChpVcGRhdGVGZWVkQWN0aW9uU2V0UmVxdWVzdBJDCgphY3Rpb25fc2V0GAEgASgLMiQubGlicm'
        'FyaWFuLnNlcGhpcmFoLnYxLkZlZWRBY3Rpb25TZXRSCWFjdGlvblNldA==');
...
final $typed_data.Uint8List listFeedActionSetsResponseDescriptor =
    $convert.base64Decode(
        ...
        '4udjEuUGFnaW5nUmVzcG9uc2VSBnBhZ2luZxJFCgthY3Rpb25fc2V0cxgCIAMoCzIkLmxpYnJh'
        'cmlhbi5zZXBoaXJhaC52MS5GZWVkQWN0aW9uU2V0UgphY3Rpb25TZXRz');
...
const ListFeedItemsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.FeedItemDigest',
      '10': 'items'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.FeedItemCollection',
      '10': 'collection'
    },
  ],
};
...
const FeedConfig$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.FeedConfigPullStatus',
      '9': 1,
      '10': 'latestPullStatus',
      '17': true
    },
...
final $typed_data.Uint8List feedConfigDescriptor = $convert.base64Decode(
    ...
    'PwoGc3RhdHVzGAYgASgOMicubGlicmFyaWFuLnNlcGhpcmFoLnYxLkZlZWRDb25maWdTdGF0dX'
    'NSBnN0YXR1cxI+Cg1wdWxsX2ludGVydmFsGAcgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0'
    'aW9uUgxwdWxsSW50ZXJ2YWwSGgoIY2F0ZWdvcnkYCCABKAlSCGNhdGVnb3J5Eh0KCmhpZGVfaX'
    'RlbXMYCSABKAhSCWhpZGVJdGVtcxJJChBsYXRlc3RfcHVsbF90aW1lGAogASgLMhouZ29vZ2xl'
    'LnByb3RvYnVmLlRpbWVzdGFtcEgAUg5sYXRlc3RQdWxsVGltZYgBARJeChJsYXRlc3RfcHVsbF'
    '9zdGF0dXMYCyABKA4yKy5saWJyYXJpYW4uc2VwaGlyYWgudjEuRmVlZENvbmZpZ1B1bGxTdGF0'
    'dXNIAVIQbGF0ZXN0UHVsbFN0YXR1c4gBARIzChNsYXRlc3RfcHVsbF9tZXNzYWdlGAwgASgJSA'
    'JSEWxhdGVzdFB1bGxNZXNzYWdliAEBQhMKEV9sYXRlc3RfcHVsbF90aW1lQhUKE19sYXRlc3Rf'
    'cHVsbF9zdGF0dXNCFgoUX2xhdGVzdF9wdWxsX21lc3NhZ2U=');
