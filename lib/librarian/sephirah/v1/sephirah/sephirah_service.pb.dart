...
class GetServerInformationResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set serverInformation($10.ServerInformation value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class ListenServerEventRequest extends $pb.GeneratedMessage {
  ...
  factory ListenServerEventRequest.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ListenServerEventRequest.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
...
class ListenServerEventResponse extends $pb.GeneratedMessage {
  ...
  factory ListenServerEventResponse.fromBuffer($core.List<$core.int> data, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(data, registry);
  factory ListenServerEventResponse.fromJson($core.String json, [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(json, registry);
  ...
  @$pb.TagNumber(2)
  set occurTime($7.Timestamp value) => $_setField(2, value);
  @$pb.TagNumber(2)
