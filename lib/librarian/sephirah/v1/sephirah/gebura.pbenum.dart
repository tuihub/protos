...
class AppSaveFileCapacityStrategy extends $pb.ProtobufEnum {
  ...
  static final $core.List<AppSaveFileCapacityStrategy?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static AppSaveFileCapacityStrategy? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
