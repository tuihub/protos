...
class FeedConfigStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<FeedConfigStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static FeedConfigStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class FeedConfigPullStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<FeedConfigPullStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static FeedConfigPullStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
