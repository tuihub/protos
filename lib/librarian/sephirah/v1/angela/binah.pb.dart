...
import '../sephirah/binah.pb.dart' as $1;
...
class ListStorageCapacityUsageRequest extends $pb.GeneratedMessage {
  ...
  factory ListStorageCapacityUsageRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListStorageCapacityUsageRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListStorageCapacityUsageRequest',
  ...
  ListStorageCapacityUsageRequest clone() =>
      ListStorageCapacityUsageRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStorageCapacityUsageRequest copyWith(
          void Function(ListStorageCapacityUsageRequest) updates) =>
      super.copyWith(
              (message) => updates(message as ListStorageCapacityUsageRequest))
          as ListStorageCapacityUsageRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageRequest create() =>
      ListStorageCapacityUsageRequest._();
  @$core.override
  ListStorageCapacityUsageRequest createEmptyInstance() => create();
  static $pb.PbList<ListStorageCapacityUsageRequest> createRepeated() =>
      $pb.PbList<ListStorageCapacityUsageRequest>();
  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListStorageCapacityUsageRequest>(
          create);
...
class ListStorageCapacityUsageResponse_Item extends $pb.GeneratedMessage {
  factory ListStorageCapacityUsageResponse_Item({
    $0.InternalID? userId,
    $1.StorageCapacityUsage? storageCapacityUsage,
  }) {
    final result = create();
  ...
  factory ListStorageCapacityUsageResponse_Item.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListStorageCapacityUsageResponse_Item.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListStorageCapacityUsageResponse.Item',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'librarian.sephirah.v1.angela'),
      createEmptyInstance: create)
    ..aOM<$0.InternalID>(1, _omitFieldNames ? '' : 'userId',
        subBuilder: $0.InternalID.create)
    ..aOM<$1.StorageCapacityUsage>(
        2, _omitFieldNames ? '' : 'storageCapacityUsage',
        subBuilder: $1.StorageCapacityUsage.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStorageCapacityUsageResponse_Item clone() =>
      ListStorageCapacityUsageResponse_Item()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStorageCapacityUsageResponse_Item copyWith(
          void Function(ListStorageCapacityUsageResponse_Item) updates) =>
      super.copyWith((message) =>
              updates(message as ListStorageCapacityUsageResponse_Item))
          as ListStorageCapacityUsageResponse_Item;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageResponse_Item create() =>
      ListStorageCapacityUsageResponse_Item._();
  @$core.override
  ListStorageCapacityUsageResponse_Item createEmptyInstance() => create();
  static $pb.PbList<ListStorageCapacityUsageResponse_Item> createRepeated() =>
      $pb.PbList<ListStorageCapacityUsageResponse_Item>();
  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageResponse_Item getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          ListStorageCapacityUsageResponse_Item>(create);
  ...
  @$pb.TagNumber(2)
  $1.StorageCapacityUsage get storageCapacityUsage => $_getN(1);
  @$pb.TagNumber(2)
  set storageCapacityUsage($1.StorageCapacityUsage value) =>
      $_setField(2, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $1.StorageCapacityUsage ensureStorageCapacityUsage() => $_ensure(1);
}
...
class ListStorageCapacityUsageResponse extends $pb.GeneratedMessage {
  ...
  factory ListStorageCapacityUsageResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ListStorageCapacityUsageResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ListStorageCapacityUsageResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'librarian.sephirah.v1.angela'),
      createEmptyInstance: create)
    ..aOM<$0.PagingResponse>(1, _omitFieldNames ? '' : 'paging',
        subBuilder: $0.PagingResponse.create)
    ..pc<ListStorageCapacityUsageResponse_Item>(
        2, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM,
        subBuilder: ListStorageCapacityUsageResponse_Item.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStorageCapacityUsageResponse clone() =>
      ListStorageCapacityUsageResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListStorageCapacityUsageResponse copyWith(
          void Function(ListStorageCapacityUsageResponse) updates) =>
      super.copyWith(
              (message) => updates(message as ListStorageCapacityUsageResponse))
          as ListStorageCapacityUsageResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageResponse create() =>
      ListStorageCapacityUsageResponse._();
  @$core.override
  ListStorageCapacityUsageResponse createEmptyInstance() => create();
  static $pb.PbList<ListStorageCapacityUsageResponse> createRepeated() =>
      $pb.PbList<ListStorageCapacityUsageResponse>();
  @$core.pragma('dart2js:noInline')
  static ListStorageCapacityUsageResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ListStorageCapacityUsageResponse>(
          create);
...
class SimpleUploadFileResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'librarian.sephirah.v1.angela'),
      createEmptyInstance: create)
    ..e<$1.FileTransferStatus>(
        1, _omitFieldNames ? '' : 'status', $pb.PbFieldType.OE,
        defaultOrMaker: $1.FileTransferStatus.FILE_TRANSFER_STATUS_UNSPECIFIED,
        valueOf: $1.FileTransferStatus.valueOf,
        enumValues: $1.FileTransferStatus.values)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $1.FileTransferStatus get status => $_getN(0);
  @$pb.TagNumber(1)
  set status($1.FileTransferStatus value) => $_setField(1, value);
  @$pb.TagNumber(1)
