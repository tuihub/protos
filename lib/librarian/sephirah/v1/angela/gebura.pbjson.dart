...
const SearchAppInfosResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.sephirah.AppInfo',
      '10': 'appInfos'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.sephirah.StoreApp',
      '10': 'storeApp'
    },
  ],
};
...
final $typed_data.Uint8List createStoreAppResponseDescriptor =
...
final $typed_data.Uint8List updateStoreAppResponseDescriptor =
    $convert.base64Decode('ChZVcGRhdGVTdG9yZUFwcFJlc3BvbnNl');
...
const ListStoreAppsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'source_filter', '3': 3, '4': 3, '5': 9, '10': 'sourceFilter'},
    {
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.sephirah.AppType',
      '10': 'typeFilter'
    },
    {
      '1': 'id_filter',
...
const ListStoreAppBinariesResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.sephirah.StoreAppBinary',
      '10': 'binaries'
    },
  ],
};
...
final $typed_data.Uint8List updateStoreAppBinaryRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateStoreAppBinaryResponseDescriptor =
    $convert.base64Decode('ChxVcGRhdGVTdG9yZUFwcEJpbmFyeVJlc3BvbnNl');
...
const ListStoreAppBinaryFilesResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.sephirah.StoreAppBinaryFile',
      '10': 'files'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.sephirah.StoreAppSaveFile',
      '10': 'saveFile'
    },
  ],
};
...
final $typed_data.Uint8List createStoreAppSaveFileRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List createStoreAppSaveFileResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateStoreAppSaveFileRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateStoreAppSaveFileResponseDescriptor =
    $convert.base64Decode('Ch5VcGRhdGVTdG9yZUFwcFNhdmVGaWxlUmVzcG9uc2U=');
...
final $typed_data.Uint8List uploadStoreAppSaveFileRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List uploadStoreAppSaveFileResponseDescriptor =
    $convert.base64Decode('Ch5VcGxvYWRTdG9yZUFwcFNhdmVGaWxlUmVzcG9uc2U=');
...
final $typed_data.Uint8List deleteStoreAppSaveFileRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List deleteStoreAppSaveFileResponseDescriptor =
    $convert.base64Decode('Ch5EZWxldGVTdG9yZUFwcFNhdmVGaWxlUmVzcG9uc2U=');
