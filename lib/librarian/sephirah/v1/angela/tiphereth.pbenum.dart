...
class SentinelStatus extends $pb.ProtobufEnum {
  ...
  static final $core.List<SentinelStatus?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static SentinelStatus? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
