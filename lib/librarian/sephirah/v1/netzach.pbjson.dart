  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.NotifyTarget',
      '10': 'target'
    },
  ],
};
...
final $typed_data.Uint8List createNotifyTargetRequestDescriptor =
...
final $typed_data.Uint8List createNotifyTargetResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateNotifyTargetRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateNotifyTargetResponseDescriptor =
    $convert.base64Decode('ChpVcGRhdGVOb3RpZnlUYXJnZXRSZXNwb25zZQ==');
...
const ListNotifyTargetsRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.NotifyTargetStatus',
      '10': 'statusFilter'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.NotifyFlow',
      '10': 'flow'
    },
  ],
};
...
final $typed_data.Uint8List createNotifyFlowRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List createNotifyFlowResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateNotifyFlowRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateNotifyFlowResponseDescriptor =
    $convert.base64Decode('ChhVcGRhdGVOb3RpZnlGbG93UmVzcG9uc2U=');
...
const NotifyFlow$json = {
  ...
  '2': [
    ...
    {'1': 'description', '3': 3, '4': 1, '5': 9, '10': 'description'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.NotifyFlowSource',
      '10': 'sources'
    },
    {
      '1': 'targets',
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.NotifyFlowTarget',
      '10': 'targets'
    },
    {
      '1': 'status',
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.NotifyFlowStatus',
      '10': 'status'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.NotifyFilter',
      '10': 'filter'
    },
    {
      '1': 'source_id',
...
const ListSystemNotificationsRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.SystemNotificationLevel',
      '10': 'levelFilter'
    },
    {
      '1': 'status_filter',
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.SystemNotificationStatus',
      '10': 'statusFilter'
    },
  ],
};
...
final $typed_data.Uint8List listSystemNotificationsRequestDescriptor = $convert.base64Decode(
    ...
    'FyaWFuLnYxLlBhZ2luZ1JlcXVlc3RSBnBhZ2luZxJRCgxsZXZlbF9maWx0ZXIYAyADKA4yLi5s'
    'aWJyYXJpYW4uc2VwaGlyYWgudjEuU3lzdGVtTm90aWZpY2F0aW9uTGV2ZWxSC2xldmVsRmlsdG'
    'VyElQKDXN0YXR1c19maWx0ZXIYBCADKA4yLy5saWJyYXJpYW4uc2VwaGlyYWgudjEuU3lzdGVt'
    'Tm90aWZpY2F0aW9uU3RhdHVzUgxzdGF0dXNGaWx0ZXI=');
...
const ListSystemNotificationsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.SystemNotification',
      '10': 'notifications'
    },
  ],
};
...
final $typed_data.Uint8List listSystemNotificationsResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateSystemNotificationRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List updateSystemNotificationResponseDescriptor =
    $convert.base64Decode('CiBVcGRhdGVTeXN0ZW1Ob3RpZmljYXRpb25SZXNwb25zZQ==');
...
final $typed_data.Uint8List systemNotificationDescriptor = $convert.base64Decode(
    ...
    'xJRFICaWQSRAoFbGV2ZWwYAyABKA4yLi5saWJyYXJpYW4uc2VwaGlyYWgudjEuU3lzdGVtTm90'
    'aWZpY2F0aW9uTGV2ZWxSBWxldmVsEkcKBnN0YXR1cxgEIAEoDjIvLmxpYnJhcmlhbi5zZXBoaX'
    'JhaC52MS5TeXN0ZW1Ob3RpZmljYXRpb25TdGF0dXNSBnN0YXR1cxIUCgV0aXRsZRgFIAEoCVIF'
    'dGl0bGUSGAoHY29udGVudBgGIAEoCVIHY29udGVudBI7CgtjcmVhdGVfdGltZRgHIAEoCzIaLm'
    'dvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCmNyZWF0ZVRpbWUSOwoLdXBkYXRlX3RpbWUYCCAB'
