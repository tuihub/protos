...
const PorterConnectionStatus$json = {
  ...
  '2': [
    ...
    {'1': 'PORTER_CONNECTION_STATUS_QUEUEING', '2': 1},
    {'1': 'PORTER_CONNECTION_STATUS_CONNECTED', '2': 2},
    {'1': 'PORTER_CONNECTION_STATUS_DISCONNECTED', '2': 3},
    {'1': 'PORTER_CONNECTION_STATUS_ACTIVE', '2': 4},
    {'1': 'PORTER_CONNECTION_STATUS_ACTIVATION_FAILED', '2': 5},
    {'1': 'PORTER_CONNECTION_STATUS_DOWNGRADED', '2': 6},
  ],
};
...
final $typed_data.Uint8List porterConnectionStatusDescriptor = $convert.base64Decode(
    ...
    'NQRUNJRklFRBAAEiUKIVBPUlRFUl9DT05ORUNUSU9OX1NUQVRVU19RVUVVRUlORxABEiYKIlBP'
    'UlRFUl9DT05ORUNUSU9OX1NUQVRVU19DT05ORUNURUQQAhIpCiVQT1JURVJfQ09OTkVDVElPTl'
    '9TVEFUVVNfRElTQ09OTkVDVEVEEAMSIwofUE9SVEVSX0NPTk5FQ1RJT05fU1RBVFVTX0FDVElW'
    'RRAEEi4KKlBPUlRFUl9DT05ORUNUSU9OX1NUQVRVU19BQ1RJVkFUSU9OX0ZBSUxFRBAFEicKI1'
    'BPUlRFUl9DT05ORUNUSU9OX1NUQVRVU19ET1dOR1JBREVEEAY=');
...
const RegisterUserRequest$json = {
  ...
  '2': [
    ...
    {'1': 'password', '3': 2, '4': 1, '5': 9, '10': 'password'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.RegisterUserRequest.Captcha',
      '9': 0,
      '10': 'captcha',
      '17': true
    },
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.RegisterUserResponse.ImageCaptcha',
      '9': 0,
      '10': 'captcha'
    },
    {
...
final $typed_data.Uint8List registerDeviceRequestDescriptor = $convert.base64Decode(
    'ChVSZWdpc3RlckRldmljZVJlcXVlc3QSPgoLZGV2aWNlX2luZm8YASABKAsyHS5saWJyYXJpYW'
    '4uc2VwaGlyYWgudjEuRGV2aWNlUgpkZXZpY2VJbmZvEisKD2NsaWVudF9sb2NhbF9pZBgCIAEo'
    'CUgAUg1jbGllbnRMb2NhbElkiAEBQhIKEF9jbGllbnRfbG9jYWxfaWQ=');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.UserSession',
      '10': 'sessions'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.Account',
      '10': 'accounts'
    },
  ],
};
...
final $typed_data.Uint8List listLinkAccountsResponseDescriptor =
    $convert.base64Decode(
        'ChhMaXN0TGlua0FjY291bnRzUmVzcG9uc2USOgoIYWNjb3VudHMYASADKAsyHi5saWJyYXJpYW'
        '4uc2VwaGlyYWgudjEuQWNjb3VudFIIYWNjb3VudHM=');
...
const ListPorterDigestsRequest$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 14,
      '6': '.librarian.sephirah.v1.UserStatus',
      '10': 'statusFilter'
    },
  ],
};
...
final $typed_data.Uint8List listPorterDigestsRequestDescriptor = $convert.base64Decode(
    ...
    'YxLlBhZ2luZ1JlcXVlc3RSBnBhZ2luZxJGCg1zdGF0dXNfZmlsdGVyGAIgAygOMiEubGlicmFy'
    'aWFuLnNlcGhpcmFoLnYxLlVzZXJTdGF0dXNSDHN0YXR1c0ZpbHRlcg==');
...
const ListPorterDigestsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.librarian.sephirah.v1.PorterDigest',
      '10': 'porterDigests'
    },
  ],
};
...
final $typed_data.Uint8List listPorterDigestsResponseDescriptor = $convert.base64Decode(
    ...
    '52MS5QYWdpbmdSZXNwb25zZVIGcGFnaW5nEkoKDnBvcnRlcl9kaWdlc3RzGAIgAygLMiMubGli'
    'cmFyaWFuLnNlcGhpcmFoLnYxLlBvcnRlckRpZ2VzdFINcG9ydGVyRGlnZXN0cw==');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.librarian.sephirah.v1.PorterContext',
      '10': 'context'
    },
  ],
};
...
const User$json = {
  ...
  '2': [
    ...
    {'1': 'password', '3': 3, '4': 1, '5': 9, '10': 'password'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.UserType',
      '10': 'type'
    },
    {
      '1': 'status',
...
const Device$json = {
  ...
  '2': [
    ...
    {'1': 'device_name', '3': 2, '4': 1, '5': 9, '10': 'deviceName'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.SystemType',
      '10': 'systemType'
    },
...
final $typed_data.Uint8List deviceDescriptor = $convert.base64Decode(
    ...
    'RldmljZUlkEh8KC2RldmljZV9uYW1lGAIgASgJUgpkZXZpY2VOYW1lEkIKC3N5c3RlbV90eXBl'
    'GAMgASgOMiEubGlicmFyaWFuLnNlcGhpcmFoLnYxLlN5c3RlbVR5cGVSCnN5c3RlbVR5cGUSJQ'
    'oOc3lzdGVtX3ZlcnNpb24YBCABKAlSDXN5c3RlbVZlcnNpb24SHwoLY2xpZW50X25hbWUYBSAB'
    'KAlSCmNsaWVudE5hbWUSOwoaY2xpZW50X3NvdXJjZV9jb2RlX2FkZHJlc3MYBiABKAlSF2NsaW'
    'VudFNvdXJjZUNvZGVBZGRyZXNzEiUKDmNsaWVudF92ZXJzaW9uGAcgASgJUg1jbGllbnRWZXJz'
    'aW9u');
...
const Porter$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.PorterConnectionStatus',
      '10': 'connectionStatus'
    },
    {
...
const PorterContext$json = {
  ...
  '2': [
    ...
    {'1': 'description', '3': 6, '4': 1, '5': 9, '10': 'description'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.PorterContextStatus',
      '10': 'status'
    },
    {
      '1': 'handle_status',
      ...
      '4': 1,
      '5': 14,
      '6': '.librarian.sephirah.v1.PorterContextHandleStatus',
      '10': 'handleStatus'
    },
    {
