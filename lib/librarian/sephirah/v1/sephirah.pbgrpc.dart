...
class LibrarianSephirahServiceClient extends $grpc.Client {
  ...
  static final _$refreshApp = $grpc.ClientMethod<$4.RefreshAppRequest, $4.RefreshAppResponse>(
      '/librarian.sephirah.v1.LibrarianSephirahService/RefreshApp',
      ($4.RefreshAppRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $4.RefreshAppResponse.fromBuffer(value));
  ...
  static final _$getBindApps = $grpc.ClientMethod<$4.GetBindAppsRequest, $4.GetBindAppsResponse>(
      ...
      ($core.List<$core.int> value) => $4.GetBindAppsResponse.fromBuffer(value));
  ...
  static final _$getAppPackageRunTime = $grpc.ClientMethod<$4.GetAppPackageRunTimeRequest, $4.GetAppPackageRunTimeResponse>(
      ...
      ($core.List<$core.int> value) => $4.GetAppPackageRunTimeResponse.fromBuffer(value));
  ...
  static final _$listFeedConfigCategories = $grpc.ClientMethod<$6.ListFeedConfigCategoriesRequest, $6.ListFeedConfigCategoriesResponse>(
      ...
      ($core.List<$core.int> value) => $6.ListFeedConfigCategoriesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$4.RefreshAppResponse> refreshApp($4.RefreshAppRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$4.GetAppPackageRunTimeResponse> getAppPackageRunTime($4.GetAppPackageRunTimeRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$6.ListFeedConfigCategoriesResponse> listFeedConfigCategories($6.ListFeedConfigCategoriesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listFeedConfigCategories, request, options: options);
  }
...
abstract class LibrarianSephirahServiceBase extends $grpc.Service {
  ...
  LibrarianSephirahServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.GetBindAppsRequest, $4.GetBindAppsResponse>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $4.GetBindAppsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$4.GetAppPackageRunTimeRequest, $4.GetAppPackageRunTimeResponse>(
        'GetAppPackageRunTime',
        getAppPackageRunTime_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $4.GetAppPackageRunTimeRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$6.ListFeedConfigCategoriesRequest, $6.ListFeedConfigCategoriesResponse>(
        'ListFeedConfigCategories',
        listFeedConfigCategories_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.ListFeedConfigCategoriesRequest.fromBuffer(value),
  ...
  $async.Future<$4.RefreshAppResponse> refreshApp_Pre($grpc.ServiceCall call, $async.Future<$4.RefreshAppRequest> request) async {
  ...
  $async.Future<$4.GetAppPackageRunTimeResponse> getAppPackageRunTime_Pre($grpc.ServiceCall call, $async.Future<$4.GetAppPackageRunTimeRequest> request) async {
  ...
  $async.Future<$6.ListFeedConfigCategoriesResponse> listFeedConfigCategories_Pre($grpc.ServiceCall call, $async.Future<$6.ListFeedConfigCategoriesRequest> request) async {
  ...
  $async.Future<$4.RefreshAppResponse> refreshApp($grpc.ServiceCall call, $4.RefreshAppRequest request);
  ...
  $async.Future<$4.GetAppPackageRunTimeResponse> getAppPackageRunTime($grpc.ServiceCall call, $4.GetAppPackageRunTimeRequest request);
  ...
  $async.Future<$6.ListFeedConfigCategoriesResponse> listFeedConfigCategories($grpc.ServiceCall call, $6.ListFeedConfigCategoriesRequest request);
