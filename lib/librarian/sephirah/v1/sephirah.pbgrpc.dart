...
class LibrarianSephirahServiceClient extends $grpc.Client {
  ...
  static final _$presignedUploadFile = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $2.PresignedUploadFileResponse.fromBuffer(value));
  static final _$presignedUploadFileStatus = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $2.PresignedUploadFileStatusResponse.fromBuffer(value));
  ...
  static final _$getApp =
      $grpc.ClientMethod<$4.GetAppRequest, $4.GetAppResponse>(
  ...
  static final _$addAppPackageRunTime = $grpc.ClientMethod<
          $4.AddAppPackageRunTimeRequest, $4.AddAppPackageRunTimeResponse>(
  ...
  $grpc.ResponseFuture<$2.PresignedUploadFileStatusResponse>
      presignedUploadFileStatus($2.PresignedUploadFileStatusRequest request,
          {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$4.GetAppResponse> getApp($4.GetAppRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$4.AddAppPackageRunTimeResponse> addAppPackageRunTime(
      $4.AddAppPackageRunTimeRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class LibrarianSephirahServiceBase extends $grpc.Service {
  ...
  LibrarianSephirahServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.AddAppPackageRunTimeRequest,
            $4.AddAppPackageRunTimeResponse>(
  ...
  $async.Future<$4.GetAppResponse> getApp_Pre(
      $grpc.ServiceCall call, $async.Future<$4.GetAppRequest> request) async {
  ...
  $async.Future<$4.AddAppPackageRunTimeResponse> addAppPackageRunTime_Pre(
      $grpc.ServiceCall call,
      $async.Future<$4.AddAppPackageRunTimeRequest> request) async {
  ...
  $async.Future<$4.GetAppResponse> getApp(
      $grpc.ServiceCall call, $4.GetAppRequest request);
