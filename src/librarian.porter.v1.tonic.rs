...
pub mod librarian_porter_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn detect_app_info(
            &mut self,
            request: impl tonic::IntoRequest<super::DetectAppInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DetectAppInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod librarian_porter_service_server {
    ...
    pub trait LibrarianPorterService: Send + Sync + 'static {
        ...
        async fn get_account(
            ...
            tonic::Status,
        >;
        async fn detect_app_info(
            &self,
            request: tonic::Request<super::DetectAppInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DetectAppInfoResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/librarian.porter.v1.LibrarianPorterService/DetectAppInfo" => {
                    #[allow(non_camel_case_types)]
                    struct DetectAppInfoSvc<T: LibrarianPorterService>(pub Arc<T>);
                    impl<
                        T: LibrarianPorterService,
                    > tonic::server::UnaryService<super::DetectAppInfoRequest>
                    for DetectAppInfoSvc<T> {
                        type Response = super::DetectAppInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LibrarianPorterService>::detect_app_info(
                                        &inner,
                                        request,
                                    )
                                    .await
